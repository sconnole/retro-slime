...
export default function Card({ power, name, imageUrl, effect, description }: CardProps) {
  return (
    <div className="relative aspect-[1/1] w-full overflow-hidden rounded-lg border-[3px] border-yellow-400 bg-gradient-to-br from-yellow-100 to-yellow-200 shadow-[0_0_10px_rgba(0,0,0,0.3)] dark:border-yellow-600 dark:from-gray-800 dark:to-gray-900">
